            ...
            <div class="card">
                ...
                <!-- 输出后端报错结束 -->
                    ...
                    <user-addresses-create-and-edit inline-template>
                        @if($address->id)
                            <form class="form-horizontal" role="form" action="{{route('user_addresses.edit', [$address])}}" method="post">
                                {{ method_field('PUT') }}
                        @else
                        ...
                        {{ csrf_field() }}
                        <!-- 注意这里多了 @change -->
                            <select-district v-bind:init-value="{{ json_encode([$address->province, $address->city, $address->district]) }}" @change="onDistrictChanged" inline-template>
